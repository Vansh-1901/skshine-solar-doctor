...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 md:pt-36 pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative">
        ...
        >
          ...
          <p className="mt-3 text-sm lg:text-base text-white/70 leading-relaxed max-w-2xl">
            ...
            Off-Grid and Hybrid systems. We help you slash electricity bills, maximise savings and
            transition to clean renewable energy through expert consultation, professional
          ...
          <div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-xs text-white/80">
            <span className="inline-flex items-center gap-1.5">
              <ShieldCheck className="h-4 w-4 text-accent-glow" /> 25-Year Panel Warranty
            </span>
            <span className="inline-flex items-center gap-1.5">
              <BadgeCheck className="h-4 w-4 text-accent-glow" /> MNRE Approved
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Zap className="h-4 w-4 text-accent-glow" /> Subsidy Assistance
            </span>
          </div>
        </motion.div>
      </div>
      ...
      {/* Stats */}
      <div className="absolute bottom-0 inset-x-0 translate-y-[12%] md:translate-y-[15%] z-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            {[
              { v: 120, s: "+", label: "Projects Completed", icon: BadgeCheck },
              { v: 850, s: " kW", label: "Solar Capacity Installed", icon: Zap },
              { v: 110, s: "+", label: "Happy Customers", icon: Users },
              ...
              <div key={s.label} className="text-center px-2">
                ...
                <div className="text-[11px] md:text-xs text-muted-foreground mt-1 uppercase tracking-wide font-medium">
                  {s.label}
                </div>
              </div>
            ))}
